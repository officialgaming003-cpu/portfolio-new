    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 border-2 border-purple-500 rounded-full mb-8"
        >
          <span className="text-purple-600 font-bold text-sm">🔷 ABOUT ME</span>
        </motion.div>
        ...
        >
          Need a full-stack web application? An automated Telegram bot? A 24/7 bank mutation scraper? I handle end-to-end development, from initial architecture to production deployment. Tech stacks are fully adaptable — what matters is that it works reliably in production.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
          {[
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl border-3 border-gray-900 bg-white hover:shadow-lg smooth-transition"
            >
