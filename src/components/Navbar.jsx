    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          {/* CTA Button */}
          <button className="hidden md:block px-6 py-2.5 bg-purple-500 text-white rounded-full font-semibold hover:bg-purple-600 smooth-transition shadow-md">
            📞 LET'S TALK
          </button>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-4 py-3 space-y-3">
              <a href="#home" className="block py-2 text-gray-700 hover:text-purple-600 font-medium">
                HOME
              </a>
              <a href="#store" className="block py-2 text-gray-700 hover:text-purple-600 font-medium">
                STORE
              </a>
              <button className="w-full mt-4 px-4 py-2.5 bg-purple-500 text-white rounded-full font-semibold">
                LET'S TALK
              </button>
            </div>
          </motion.div>
